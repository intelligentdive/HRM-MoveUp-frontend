                ...
                <div className="flex items-center gap-[35px]">
                    {
                        isPage == 1 ?
                            ...
                            :
                            <button className="text-[#8F9BB3]" onClick={() => setIsPage(1)}>Invoices</button>
                    }
                    {
                        isPage == 2 ?
                            <button onClick={() => setIsPage(2)}>Payments</button>
                            :
                            <button className="text-[#8F9BB3]" onClick={() => setIsPage(2)}>Payments</button>
                    }
                    {
                        isPage == 3 ?
                            <button onClick={() => setIsPage(3)}>Expences</button>
                            :
                            <button className="text-[#8F9BB3]" onClick={() => setIsPage(3)}>Expences</button>
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[16px] mt-[37px]">
                    ...
                    <div className="bg-white py-[24px] px-[22px] rounded-2xl border-gray-300 border">
                        ...
                        <div className="xl:flex lg:block items-center justify-between gap-1">
                            ...
                            <p className="flex items-center"><AiOutlineVerticalAlignTop size={20} color="#0095FF"></AiOutlineVerticalAlignTop> <span className="text-[#0095FF]">5%</span></p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white py-[24px] px-[22px] rounded-2xl border-gray-300 border">
                        ...
                        <div className="xl:flex lg:block items-center justify-between gap-1">
                            <p className="text-[#8F9BB3] ">This Years</p >
                            <p className="flex items-center"><AiOutlineVerticalAlignTop size={20} color="#0095FF"></AiOutlineVerticalAlignTop> <span className="text-[#0095FF]">20%</span></p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white py-[24px] px-[22px] rounded-2xl border-gray-300 border">
                        ...
                        <div className="xl:flex lg:block items-center justify-between gap-1">
                            <p className="text-[#8F9BB3] ">This Years</p >
                            <p className="flex items-center"><AiOutlineVerticalAlignTop size={20} color="#0095FF"></AiOutlineVerticalAlignTop> <span className="text-[#0095FF]">17%</span></p>
                        </div>
                    </div>
