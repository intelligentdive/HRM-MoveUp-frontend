    ...
    return (
        <div className="mb-[128px]">
            ...
            <div className="border rounded-lg border-gray-200 bg-white w-full mt-[25px] flex items-center justify-around py-[30px]">
                <div>
                    <h3 className="text-center text-[20px] font-bold">552</h3>
                    <p className="text-[#8F9BB3] text-center">Total Approved</p>
                </div>
                <div>
                    <h3 className="text-center text-[20px] font-bold">182</h3>
                    <p className="text-[#8F9BB3] text-center">Pending Invoice</p>
                </div>
                <div>
                    <h3 className="text-center text-[20px] font-bold">982</h3>
                    <p className="text-[#8F9BB3] text-center">Closed</p>
                </div>
            </div>
