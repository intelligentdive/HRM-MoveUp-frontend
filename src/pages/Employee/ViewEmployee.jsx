                ...
                <div className="grid xl:grid-cols-9 lg:grid-cols-9 grid-cols-4 gap-6">
                    ...
                    <div className="xl:col-span-3 lg:col-span-3 col-span-1">
                        <div className="border border-gray-300 bg-white rounded-lg">
                            ...
                            <hr />
                            <p className='mt-5 mx-5 text-[#8F9BB3]'>Invest in life – in your life. No more wavering dreams, staring out the window and wishing and hoping. No more sleepless nights worrying about your future as you only see where you are now.</p>
                            <button className='mt-5 mb-5 ml-5 btn bg-[#0095FF] hover:bg-[#0095FF] text-white btn-sm'><img src={twiter} alt="" className='w-6' />Follow</button>
                        </div>

                        <div className='relative'>
                            <select className="select select-bordered w-full mt-4 font-semibold text-[16px]">
                                <option disabled selected>Statitics</option>
                                <option>Han Solo</option>
                                <option>Greedo</option>
                            </select>
                            <button
                                className='absolute mt-7 right-10' >
                                X
                            </button>
                        </div>
                    </div>
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <div
                                    ...
                                    <h3 className='text-neutral-500 mt-4'>Contrary to popular belief, Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim vietnam.</h3>
                                </div>
                            </li>
